...
//This is not valid because FinalExample class is final that means we CANNOT inherit
public class UseFinalExample {
    public static void main(String[] args) {

        FinalExample obj = new FinalExample();
        System.out.println(obj.a);
        //obj.a = 10; // since an is final instance variable, we CANNOT change the value.
        System.out.println(obj.a);
