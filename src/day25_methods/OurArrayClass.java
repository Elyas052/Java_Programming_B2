...
public class OurArrayClass {
    public static void firstElem(int[] nums) {System.out.println("First Element: " + nums[0]);}
    ...
    // Print middle numbers -- > If the size is EVEN taking the middle two, else take the middle one.
