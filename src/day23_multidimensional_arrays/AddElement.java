...
public class AddElement {
    public static void main(String[] args) {
        ...
        int[] arr = new int[size];  // I made a new array with the size that user gave
        ...
        int[] arr2 = Arrays.copyOf(arr, arr.length + 1);   // size of a new array: whatEverUserGave make 1 more
