...
public class Wild {
    public static void main(String[] args) {
        ...
        // Reptile reference does not have access to skinColor variable.
        //reptile.skinColor = "green";
        ...
        // Animal reference does not have access to numberOfClaws variable.
        //animal.numberOfClaws = 10;

        // Animal reference does not have access to skinColor variable.
