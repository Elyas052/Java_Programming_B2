...
public class QueueObjects {
    public static void main(String[] args) {
        ...
        System.out.println(queue.remove(3)); //Since it also returns the boolean, once there is a matching object, it will return true. Otherwise, false
        System.out.println(queue.remove(1)); // It removes the first matching one.
        System.out.println(queue);

        queue.poll(); // It removed the elements from the beginning since it works with the FIFO
        System.out.println(queue);
