...
public class ListVsSet {
    public static void main(String[] args) {
        ...
        // Reference is List interface - object is ArrayList class
        ...
        */
        ...
        // Set does not work with indexes. That is why we cannot get the element in this way.
        ...
        for (Integer each : set) { //         for ( int each : set) { -- > DOWN-CASTING / UNBOXING
