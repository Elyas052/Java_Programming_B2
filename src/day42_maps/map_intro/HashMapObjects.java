...
public class HashMapObjects {
    public static void main(String[] args) {
        ...
        //map2.put(-2, "two");
        //map2.put(null, "hello");
        System.out.println(map2); // HashMap order is not keeping the insertion order. It is a RANDOM order (Not sorted either)


        // how do we read the key/value from map --- > get(KEY) --- > will give us the value based on the KEY
        System.out.println(map2.get(10));  // 10 is not the index --- > it is object 10 that is the KEY
        ...
        // If you provide an already EXISTING KEY, the new VALUE will be assigned to the EXISTING KEY.
