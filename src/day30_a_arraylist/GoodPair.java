...
/*
    ...
    Create a method that will accept an Integer ArrayList and check for good pairs. A pair is an element and the element next to it.
    A good pair is whenever the first number in the pair is bigger than the second number. Remove any bad pairs for the ArrayList and return the
