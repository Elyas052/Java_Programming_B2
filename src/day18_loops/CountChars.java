...
public class CountChars {
    public static void main(String[] args) {
        ...
        System.out.println("Uppercase character count: " + countUpperChar);
        System.out.println("Lowercase character count: " + countLowerChar);
        System.out.println("Number character count: " + countDig);
        System.out.println("Special character count: " + countSpecialChar);
